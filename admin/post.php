        ...
        <div class="container">
            ...
            <div class="card col-md-12 mt-2">
                ...
                <div class="card-body">
                    ...
                    if (!$post['state']) {
                    ?>
                        <a class="btn btn-success" href="./statePost.php?post_id=<?php echo $post["id"] ?>&toState=1">Enable this post</a>

                    <?php
                    } else {
                    ?>
                        <a class="btn btn-danger" href="./statePost.php?post_id=<?php echo $post["id"] ?>&toState=0">Unenable  this post</a>
                    <?php
                    }
                    ?>
                </div>
